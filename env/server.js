...
// Use commands `npm run start --static` or `npm run start-static` for start static route for dist
if (process.env.npm_config_static || process.argv.indexOf('--static') > -1) {
