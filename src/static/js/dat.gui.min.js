...
dat.dom.dom=function(e){ function a(b){ if(b==='0'||e.isUndefined(b))return 0;b=b.match(d);return!e.isNull(b)?parseFloat(b[1]):0; }var c={};e.each({HTMLEvents:[
'change'
],MouseEvents:[
'click','mousemove','mousedown','mouseup','mouseover'
],KeyboardEvents:[
'keydown'
]},function(b,a){ e.each(b,function(b){ c[b]=a; }); });var d=/(\d+(\.\d+)?)px/,f={makeSelectable:function(b,a){ if(!(b===void 0||b.style===void 0))b.onselectstart=a?function(){ return false; }:function(){},b.style.MozUserSelect=a?'auto':'none',b.style.KhtmlUserSelect=
...
dat.color.interpret=function(e,a){ var c,d,f=[
...
3?false:{space:'RGB',r:a[0],g:a[1],b:a[2]}; },write:function(a){ return[
a.r,a.g,a.b
]; }},RGBA_ARRAY:{read:function(a){ return a.length!=4?false:{space:'RGB',r:a[0],g:a[1],b:a[2],a:a[3]}; },write:function(a){ return[
a.r,a.g,a.b,a.a
]; }}}},{litmus:a.isObject,conversions:{RGBA_OBJ:{read:function(b){ return a.isNumber(b.r)&&a.isNumber(b.g)&&a.isNumber(b.b)&&a.isNumber(b.a)?{space:'RGB',r:b.r,g:b.g,b:b.b,a:b.a}:false; },write:function(a){ return{r:a.r,g:a.g,b:a.b,a:a.a}; }},RGB_OBJ:{read:function(b){ return a.isNumber(b.r)&&
a.isNumber(b.g)&&a.isNumber(b.b)?{space:'RGB',r:b.r,g:b.g,b:b.b}:false; },write:function(a){ return{r:a.r,g:a.g,b:a.b}; }},HSVA_OBJ:{read:function(b){ return a.isNumber(b.h)&&a.isNumber(b.s)&&a.isNumber(b.v)&&a.isNumber(b.a)?{space:'HSV',h:b.h,s:b.s,v:b.v,a:b.a}:false; },write:function(a){ return{h:a.h,s:a.s,v:a.v,a:a.a}; }},HSV_OBJ:{read:function(b){ return a.isNumber(b.h)&&a.isNumber(b.s)&&a.isNumber(b.v)?{space:'HSV',h:b.h,s:b.s,v:b.v}:false; },write:function(a){ return{h:a.h,s:a.s,v:a.v}; }}}}
];return function(){ d=
...
dat.GUI=dat.gui.GUI=function(e,a,c,d,f,b,n,h,j,m,l,o,y,g,i){ function q(a,b,r,c){ if(b[r]===void 0)throw Error('Object '+b+' has no property "'+r+'"');c.color?b=new l(b,r):(b=[
b,r
].concat(c.factoryArgs),b=d.apply(a,b));if(c.before instanceof f)c.before=c.before.__li;t(a,b);g.addClass(b.domElement,'c');r=document.createElement('span');g.addClass(r,'property-name');r.innerHTML=b.property;var e=document.createElement('div');e.appendChild(r);e.appendChild(b.domElement);c=s(a,e,c.before);g.addClass(c,k.CLASS_CONTROLLER_ROW);
g.addClass(c,typeof b.getValue());p(a,c,b);a.__controllers.push(b);return b; }function s(a,b,d){ var c=document.createElement('li');b&&c.appendChild(b);d?a.__ul.insertBefore(c,params.before):a.__ul.appendChild(c);a.onResize();return c; }function p(a,d,c){ c.__li=d;c.__gui=a;i.extend(c,{options:function(b){ if(arguments.length>1)return c.remove(),q(a,c.object,c.property,{before:c.__li.nextElementSibling,factoryArgs:[
i.toArray(arguments)
]});if(i.isArray(b)||i.isObject(b))return c.remove(),q(a,c.object,c.property,
{before:c.__li.nextElementSibling,factoryArgs:[
b
]}); },name:function(a){ c.__li.firstElementChild.firstElementChild.innerHTML=a;return c; },listen:function(){ c.__gui.listen(c);return c; },remove:function(){ c.__gui.remove(c);return c; }});if(c instanceof j){ var e=new h(c.object,c.property,{min:c.__min,max:c.__max,step:c.__step});i.each([
'updateDisplay','onChange','onFinishChange'
],function(a){ var b=c[a],H=e[a];c[a]=e[a]=function(){ var a=Array.prototype.slice.call(arguments);b.apply(c,a);return H.apply(e,a); }; });
g.addClass(d,'has-slider');c.domElement.insertBefore(e.domElement,c.domElement.firstElementChild); }else if(c instanceof h){ var f=function(b){ return i.isNumber(c.__min)&&i.isNumber(c.__max)?(c.remove(),q(a,c.object,c.property,{before:c.__li.nextElementSibling,factoryArgs:[
c.__min,c.__max,c.__step
]})):b; };c.min=i.compose(f,c.min);c.max=i.compose(f,c.max); }else if(c instanceof b)g.bind(d,'click',function(){ g.fakeEvent(c.__checkbox,'click'); }),g.bind(c.__checkbox,'click',function(a){ a.stopPropagation(); });
...
'rgb('+h+','+h+','+h+')'});this.__hue_knob.style.marginTop=(1-this.__color.h/360)*100+'px';this.__temp.s=1;this.__temp.v=1;b(this.__saturation_field,'left','#fff',this.__temp.toString());f.extend(this.__input.style,{backgroundColor:this.__input.value=this.__color.toString(),color:'rgb('+h+','+h+','+h+')',textShadow:this.__input_textShadow+'rgba('+j+','+j+','+j+',.7)'}); }});var j=[
'-moz-','-o-','-webkit-','-ms-',''
];return h; }(dat.controllers.Controller,dat.dom.dom,dat.color.Color=function(e,a,c,d){ function f(a,
...
a.rgb_to_hex(this.r,this.g,this.b);return this.__state.hex; },set:function(a){ this.__state.space='HEX';this.__state.hex=a; }});return j; }(dat.color.interpret,dat.color.math=function(){ var e;return{hsv_to_rgb:function(a,c,d){ var e=a/60-Math.floor(a/60),b=d*(1-c),n=d*(1-e*c),c=d*(1-(1-e)*c),a=[
[
d,c,b
],[
n,d,b
...
][Math.floor(a/60)%6];return{r:a[0]*255,g:a[1]*255,b:a[2]*255}; },rgb_to_hsv:function(a,c,d){ var e=Math.min(a,c,d),b=Math.max(a,c,d),e=b-e;if(b==0)return{h:NaN,s:0,v:0};
